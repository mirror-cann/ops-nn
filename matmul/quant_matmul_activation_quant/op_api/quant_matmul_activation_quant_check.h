...
#ifndef OP_API_INC_QUANT_MATMUL_ACTIVATION_QUANT_CHECK_H
#define OP_API_INC_QUANT_MATMUL_ACTIVATION_QUANT_CHECK_H
#include <map>
...
#endif // OP_API_INC_QUANT_MATMUL_ACTIVATION_QUANT_CHECK_H
