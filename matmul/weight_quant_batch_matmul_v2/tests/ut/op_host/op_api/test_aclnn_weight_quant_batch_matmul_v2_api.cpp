...
protected:
    static void SetUpTestCase() { cout << "l2_weight_quant_batch_matmul_v2_test_910B2 SetUp" << endl; }

    static void TearDownTestCase() { cout << "l2_weight_quant_batch_matmul_v2_test_910B2 TearDown" << endl; }
};
...
static WeightQuantBatchMatmulV2TestParam casesParamsAscend950[] = {
    ...
    {"Ascend950_case_a16mxf4_nd_invalid_antiquant_offset",
     ...
     CONTIGUOUS,
     CONTIGUOUS},
    {"Ascend950_case_nd_fp8_e4m3_offset_not_null_invalid",
     {2, 64},
     {64, 128},
     {2, 128},
     {2, 128},
     ...
     CONTIGUOUS,
     CONTIGUOUS},
    {"Ascend950_case_nd_hifloat8_offset_not_null_invalid",
     {2, 64},
     {64, 128},
     {2, 128},
     {2, 128},
