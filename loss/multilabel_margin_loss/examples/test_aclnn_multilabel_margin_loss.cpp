...
int main()
{
    ...
    std::vector<int32_t> targetHostData = {0, 1, -1, 2, -1, -1};
    ...
    ret = CreateAclTensor(istargetHostData, istargetShape, &istargetDeviceAddr, aclDataType::ACL_FLOAT, &istarget);
    CHECK_RET(ret == ACL_SUCCESS, return ret);
    ...
    ret = aclrtMemcpy(outData.data(), outData.size() * sizeof(outData[0]), outDeviceAddr, outSize * sizeof(outData[0]),
