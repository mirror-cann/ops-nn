...
/* !
 * \file inplace_index_add_tiling.cc
 * \brief
 */
...
bool InplaceIndexAddDeterminsticTiling::IsCapable()
{
...
void InplaceIndexAddDeterminsticTiling::DoOpTilingForDeterminsticSplitAfter()
{
    int64_t halfUbSize = (ubSize_ - RESERVE_SIZE) / SIMD_DB_BUFFER;
    int64_t alignNum = ALIGN_SIZE / varTypeSize_;
...
void InplaceIndexAddDeterminsticTiling::DoOpTilingForDeterminstic()
{
...
void InplaceIndexAddDeterminsticTiling::SetTilingData()
{
...
ge::graphStatus InplaceIndexAddDeterminsticTiling::DoOpTiling()
{
    if (isDeterminstic_ == 1) {
...
ge::graphStatus InplaceIndexAddDeterminsticTiling::GetWorkspaceSize()
{
...
ge::graphStatus InplaceIndexAddDeterminsticTiling::PostTiling()
{
...
void InplaceIndexAddDeterminsticTiling::DumpTilingInfo()
{
