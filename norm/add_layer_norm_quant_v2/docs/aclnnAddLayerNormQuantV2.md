...
[📄 查看源码](https://gitcode.com/cann/ops-nn/tree/master/norm/add_layer_norm_quant_v2)
...
```Cpp
aclnnStatus aclnnAddLayerNormQuantV2(
  void          *workspace,
  uint64_t       workspaceSize,
  aclOpExecutor *executor,
  aclrtStream    stream)
...
- **参数说明**
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>数据类型和shape需要与`x1`保持一致。</li></ul></td>
      <td>FLOAT32、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>数据类型和shape需要与`scales1Optional`保持一致。</li><li>可选输入参数传入时，取值约束参见<a href="#约束说明">约束说明</a>。</li></ul></td>
      <td>FLOAT32、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>shape需要与输入x1/x2一致。</li></ul></td>
      <td>INT8</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>数据类型和shape需要与输入`x1`/`x2`保持一致。</li></ul></td>
      <td>FLOAT32、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>1-8</td>
      <td>√</td>
    ...
    <tr>
      <td>layernormRes（aclTensor*）</td>
      <td>输出</td>
      <td>表示layernorm的结果输出layernormRes。对应公式中的`y`。</td>
      <td><ul><li>支持空Tensor。</li><li>数据类型和shape需要与输入`x1`/`x2`保持一致。</li></ul></td>
      <td>FLOAT32、FLOAT16、BFLOAT16</td>
      <td>ND</td>
      <td>1-8</td>
    ...
    <tr>
      ...
      <td><ul><li>支持空Tensor。</li><li>shape为输入`x1`的shape剔除掉最后一维。</li></ul></td>
      <td>FLOAT32</td>
      <td>ND</td>
      <td>0-7</td>
      <td>√</td>
...
- **参数说明**
  ...
  <tbody>
    ...
    <tr>
      <td>workspaceSize</td>
      <td>输入</td>
      <td>在Device侧申请的workspace大小，由第一段接口aclnnAddLayerNormQuantV2GetWorkspaceSize获取。</td>
    </tr>
    <tr>
      <td>executor</td>
      <td>输入</td>
